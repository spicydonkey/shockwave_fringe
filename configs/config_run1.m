...
configs.load.id=1:2992; %2992;         % file id numbers to use for analysis
...
% PAL
configs.pal.t1=1.016;      % estimated from the first pal flux peak on DLD front panel
configs.pal.dt=0.0310;      % estimated from peak diff of first and second
configs.pal.n=10;

configs.pal.nfitstart=5;    % AL pulse ID to begin fit from
