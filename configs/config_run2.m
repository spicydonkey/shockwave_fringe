...
configs.files.path='\\AMPLPC29\He BEC Archive\EXPERIMENT-DATA\AL_Shockwaves\RF_raman_combined\Run2\Run 2 data\Run 2 background no raman\d';
...
configs.load.window{1}=[1,1.35];      % T [s] include all PALs
...
% PAL
configs.pal.t1=1.021;      % estimated from the first pal flux peak on DLD front panel
configs.pal.dt=0.0161;      % estimated from peak diff of first and second
configs.pal.n=20;

configs.pal.nfitstart=10;    % AL pulse ID to begin fit from
